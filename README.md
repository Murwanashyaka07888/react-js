...
- ES7 Snippets
  - rafce (arrow func with export) //zigufasha gukora function
  - rfce (regular func with export ) //zigufasha gukora function
  - same as the file name
  - react auto import
    - uncheck
    - React Snippets › Settings: Import React On Top //ikubuza kurepeta import
